...
class TransformerConfig(ModelParallelConfig):
    ...
    """Hidden size of MoE experts. Default to ffn_hidden_size."""

    shared_expert_hidden_size: int = None
    """Hidden size of MoE shared expert. Set to None for no shared expert."""

    shared_expert_combine_method: str = None
    """Combining method between routed experts and shared experts."""
    ...
    moe_te_grouped_gemm: bool = True
    """Use the grouped gemm implement from transformer_engine."""
    ...
    """moe_router_force_load_balancing(bool): Enforce load balancing for dropless MoE routing."""
